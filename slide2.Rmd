...
dados1$ponto_fluidez_categoria <- cut(
...
tabyl(dados1, ponto_fluidez_categoria)
```
---
...
dados1$ponto_fluidez_categoria <- fct_recode(dados1$ponto_fluidez_categoria,
                                            "Baixo" = "Baixo",
                                            "Médio" = "Médio",
                                            "Alto" = "Alto")
...
```{r, eval=TRUE,include=TRUE,echo=TRUE,error=TRUE}
dados1 <- mutate(dados1, indice_saturados_aromaticos = dados$saturados / dados$aromaticos)
```

---

Para análises individuais
